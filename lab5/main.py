...
# Предмети
subjects = ['Математика (Василенко)', 'Українська мова (Василенко)', 'Англійська мова (Шевченко)',
            'Фізкультура (Мельникук)',
            'Музика (Радченко)', 'Малювання (Василенко)',
            'Трудове навчання (Василенко)', 'Природознавство (Василенко)', 'Географія (Василенко)',
            'Історія (Омельчук)',
            'Математика (Василенко)', 'Українська мова (Василенко)',
            'Англійська мова (Шевченко)', 'Фізкультура (Мельникук)', 'Музика (Радченко)', 'Малювання (Василенко)',
            'Трудове навчання', 'Природознавство', 'Географія (Василенко)', 'Історія (Омельчук)',
            'Математика (Василенко)',
            'Українська мова (Василенко)',
            'Англійська мова (Шевченко)', 'Фізкультура (Мельникук)', 'Музика (Радченко)']
